...
<Step title="Library" subtitle="sourcecode of web-vitals">
...
<Step title="metric.value">

```js 22 file=./types-metric.js
```

</Step>

<Step title="Next.js 9.4: 📢 integrated web-vitals" subtitle="a new method called reportWebVitals">
